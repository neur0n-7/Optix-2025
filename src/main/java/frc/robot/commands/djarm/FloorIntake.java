...
public class FloorIntake extends SequentialCommandGroup {
    ...
    public FloorIntake(DJArmSubsystem djarm) {
        ...
        addCommands(
            new SequentialCommandGroup(
                    ...
                    new InstantCommand(() -> djarm.setTargetPose(DJArmStoredPoses.FLOOR_INTAKE.pose)),
                    new WaitUntilCommand(() -> djarm.atTarget()),
                    new InstantCommand(() -> djarm.setEndEffectorState(EndEffectorState.CLOSED)),
